    ...
    <section class="bg-gradient-to-r from-primary to-tertiary py-20">
        <div class="container mx-auto px-6">
            <div class="max-w-3xl mx-auto text-center text-white">
                ...
                <form class="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4" x-data x-intersect="$el.classList.add('animate-fade-in-up', 'animate-delay-400')">
                    <input type="email" placeholder="Enter your email" class="w-full md:w-auto px-4 py-2 rounded-full focus:outline-none focus:ring-2 focus:ring-white text-gray-800">
