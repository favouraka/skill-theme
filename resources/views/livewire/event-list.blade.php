<div class="container mx-auto px-4 py-8">
    @if(isset($eventsDisabled) && $eventsDisabled)
        <div class="flex justify-center">
            <div class="bg-white rounded-lg shadow-md p-8 max-w-md w-full text-center">
                ...
                <h3 class="text-xl font-semibold text-gray-800 mb-2">Events Unavailable</h3>
                <p class="text-gray-600">Events are currently disabled. Please check back later.</p>
            </div>
        </div>
    @else
        @if ($events->count())
